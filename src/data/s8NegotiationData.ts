...
export const AI_KNOWN_CLUES_BY_ROUND: Record<HeroId, Record<1 | 2 | 3, string[]>> = {
  ...
  hero_hanli: {
    ...
    3: ['对玄寂的判断', '寒立守护小舞儿的秘密', '寒立的判断', '寒立看穿了旺林的压力'],
  },
  hero_wanglin: {
    1: ['逆天宗大阵的危机', '风无痕的匿名信', '旺林的摇摆立场'],
    2: ['师门危机', '萧家与逆天宗的渊源', '匿名信', '霄战与逆天老祖的关系'],
...
export const FAKE_CLUES: string[] = [
  ...
  '寂叔公对小舞儿好，只是因为他收过小舞儿兄长尔铭的一份人情。',
  '薰儿古族血脉其实是骗局——她的师父是被她自己误杀的。',
  '天元秘宝不在天渊宗，而是在坠魔谷北面的逆天宗旧址。',
  '化形丹上的灵魂印记是小舞儿兄长尔铭留下的护身符，并不是监控。',
 ...
 * @param specialPair       是否为"心心相印"必得真言关系（如 塘散↔小舞儿、萧焱↔薰儿）
 */
